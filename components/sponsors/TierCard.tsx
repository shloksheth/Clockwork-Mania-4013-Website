...
export function TierCard({ tier }: { tier: SponsorTier }) {
  if (tier.variant === "diamond") {
    return (
      <div className="tier-diamond-ring h-full min-w-[260px] shrink-0 sm:min-w-[280px]">
        <div className="flex h-full flex-col rounded-card bg-surface p-8">
  ...
  return (
    <div className="flex h-full min-w-[240px] shrink-0 flex-col rounded-card border border-[rgba(255,210,8,0.15)] bg-surface p-7 sm:min-w-[260px]">
      <h3 className="font-bebas text-4xl tracking-[0.02em] text-offwhite">
        {tier.name}
      </h3>
